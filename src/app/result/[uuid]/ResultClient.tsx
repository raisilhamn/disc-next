...
import { COLORS, LABELS, ORDER } from "@/lib/disc"
            ...
            <div className="mb-6 flex items-center justify-between gap-4">
              ...
              <div className="flex shrink-0 gap-2">
                <button
                  ...
                  className="shrink-0 rounded-md border border-border bg-card px-4 py-2 text-xs font-semibold text-foreground shadow-sm transition-colors hover:bg-muted disabled:opacity-50"
                >
